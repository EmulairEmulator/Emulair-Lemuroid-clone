package com.bigbratan.emulair.common.managers.controller
...
object EmulairTouchConfigs {
    ...
    private val PRIMARY_DIAL_CROSS = PrimaryDialConfig.Cross(
        CrossConfig(
            ...
            supportsGestures = setOf(GestureType.TRIPLE_TAP, GestureType.FIRST_TOUCH),
            rightDrawableForegroundId = R.drawable.ic_arrow_dpad
        ),
    )
        ...
        RadialGamePadConfig(
            ...
            secondaryDials = listOf(
                ...
                SecondaryDialConfig.SingleButton(
                    ...
                    ButtonConfig(
                        id = KeyEvent.KEYCODE_BUTTON_L2,
                        iconId = R.drawable.ic_close_screen,
