...
-keep,includedescriptorclasses class com.bigbratan.emulair.**$$serializer { *; }
-keepclassmembers class com.bigbratan.emulair.** {
    *** Companion;
}
-keepclasseswithmembers class com.bigbratan.emulair.** {
