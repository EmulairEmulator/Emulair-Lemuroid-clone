...
class GameActivity : BaseGameActivity() {
    ...
    override fun getDialogClass() = PauseMenuActivity::class.java
    ...
    private fun setupTouchViews(
        ...
        val theme = EmulairTouchOverlayThemes.getGamePadTheme(leftGamePadContainer)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == DIALOG_REQUEST) {
            if (data?.getBooleanExtra(PauseMenuContract.RESULT_EDIT_TOUCH_CONTROLS, false) == true) {
